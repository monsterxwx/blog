...
<span class="line"><span style="color:#24292E;">}</span></span>
<span class="line"></span>
<span class="line"><span style="color:#24292E;">&lt;/</span><span style="color:#22863A;">style</span><span style="color:#24292E;">&gt;</span></span></code></pre></div>`,4),z=JSON.parse('{"title":"打印机效果","description":"","frontmatter":{},"headers":[],"relativePath":"docs/components/custom/TypewriterText.md","filePath":"docs/components/custom/TypewriterText.md","lastUpdated":1757915074000}'),k={name:"docs/components/custom/TypewriterText.md"},V=Object.assign(k,{setup(l){return(n,s)=>(y(),i("div",null,[_,p("div",v,[f(w,{color:"#32c5ff",delSpeed:1,list:["大家好","给大家拜年了"]})]),N]))}});export{z as __pageData,V as default};
