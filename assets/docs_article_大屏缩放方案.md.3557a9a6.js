import{_ as s,c as n,o as a,Q as l}from"./chunks/framework.a7f06699.js";const A=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/article/大屏缩放方案.md","filePath":"docs/article/大屏缩放方案.md","lastUpdated":1763537176000}'),p={name:"docs/article/大屏缩放方案.md"},o=l(`<div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-o22cb" id="tab-opAsSTO" checked="checked"><label for="tab-opAsSTO">components/ScaleBox.vue</label><input type="radio" name="group-o22cb" id="tab-1qc7iV4"><label for="tab-1qc7iV4">debounce.js</label></div><div class="blocks"><div class="language-vue vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">template</span><span style="color:#E1E4E8;">&gt;</span></span>
