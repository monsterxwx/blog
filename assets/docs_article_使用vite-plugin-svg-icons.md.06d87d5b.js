import{_ as s,c as n,o as a,Q as l}from"./chunks/framework.c6c8af9d.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/article/使用vite-plugin-svg-icons.md","filePath":"docs/article/使用vite-plugin-svg-icons.md","lastUpdated":1757915074000}'),p={name:"docs/article/使用vite-plugin-svg-icons.md"},o=l(`<h2 id="安装vite-plugin-svg-icons" tabindex="-1">安装vite-plugin-svg-icons <a class="header-anchor" href="#安装vite-plugin-svg-icons" aria-label="Permalink to &quot;安装vite-plugin-svg-icons&quot;">​</a></h2><div class="language-Shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">Shell</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#B392F0;">pnpm</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">i</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">vite-plugin-svg-icons</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">-D</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#6F42C1;">pnpm</span><span style="color:#24292E;"> </span><span style="color:#032F62;">i</span><span style="color:#24292E;"> </span><span style="color:#032F62;">vite-plugin-svg-icons</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">-D</span></span></code></pre></div><h2 id="vite-config-js配置" tabindex="-1"><code>vite-config.js</code>配置 <a class="header-anchor" href="#vite-config-js配置" aria-label="Permalink to &quot;\`vite-config.js\`配置&quot;">​</a></h2><div class="language-JavaScript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">JavaScript</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> path </span><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&#39;path&#39;</span></span>
